...
import swevoq.ebread.com.Chat.Presenter.Utility.AuthPresenter;
...
public class AuthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        if(presenter.getLoggedUser() != null){
            startActivity(new Intent(AuthActivity.this,ChatListActivity.class));
            finish();
        }
                        ...
                        .addOnCompleteListener(AuthActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    Intent intent = new Intent(AuthActivity.this, ChatListActivity.class);
